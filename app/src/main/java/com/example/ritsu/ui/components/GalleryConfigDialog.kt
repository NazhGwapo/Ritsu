...
fun GalleryConfigDialog(
    ...
    AlertDialog(
        ...
        title = { Text("Select Game Config") },
        text = {
            Column {
                Text("Select the game configuration to use for importing from the gallery.")
                ...
                Box {
                    Row(
                        ...
                        Text(
                            text = selectedConfig?.gameName ?: "Select Game...",
        ...
        confirmButton = {
            TextButton(
                onClick = {
                    selectedConfig?.let { onConfigSelected(it) }
                },
